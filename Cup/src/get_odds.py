...
def get_dk():
    ...
    for page in pages:
        driver.get(
            'https://sportsbook.draftkings.com/leagues/motorsports/88670645?catergory=' + page + '&category=' + page)
        time.sleep(15)
...
def get_dfs():
    ...
    driver1 = []
    salary = []
    driver.get("https://frcs.pro/dfs/draftkings/cup/salary-cap-calculator")
    time.sleep(10)
...
if __name__ == '__main__':
    ...
    final.to_csv('../data/prediction/odds7.csv')
    dfs_salary.to_csv('../data/prediction/dfs_salary7.csv')
    print(final)
