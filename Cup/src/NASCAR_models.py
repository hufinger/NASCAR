...
def top3_refresh():
    ...
    print(a)
    print('top3 done')
    with open('../prediction_artifacts/Top3Mod_1.6.0', 'wb') as file:
...
def top5_refresh():
    ...
    print(decile_df.groupby('Decile')['Actual'].mean())
    a = decile_df.groupby('Decile')['Probability'].min()
    with open('../prediction_artifacts/Top5Mod_1.6.0', 'wb') as file:
        pickle.dump(rfecv, file)
    print(a)
...
def top10_refresh():
    ...
    # print(decile_df.groupby('Decile')['Actual'].size())
    a = decile_df.groupby('Decile')['Probability'].min()
    with open('../prediction_artifacts/Top10Mod_1.6.0', 'wb') as file:
        pickle.dump(rfecv, file)
    print(a)
...
def h2h_refresh():
    ...
    :return: nothing, but creates pickled model object
    """
    data = pd.read_csv('../data/processed/H2H-NASCAR.csv', index_col=[0])
    ...
    with open('../prediction_artifacts/H2H_2.5.0.pkl', 'wb') as file:
        pickle.dump(rfecv, file)
...
def dfs_refresh():
    ...
    :return: nothing, but creates pickled model object
    """
    data = pd.read_csv('../data/processed/DFS_NASCAR.csv', index_col=[0])
    ...
    with open('../prediction_artifacts/DFS_1.5.0.pkl', 'wb') as file:
        pickle.dump(rfecv, file)
